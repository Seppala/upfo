...
DATABASES = {
    'default': {
        ...
        'NAME': 'updb.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'm2w+sx8ayseuj@h*i9vpp53@k@m1*g92+k$f-8vhwx2obbydr5'
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
	'/Users/rikuseppala/development/upfo/upfo/upmain/templates'
)
...
FACEBOOK_ACCESS_SETTINGS = {
        ...
        "PROVIDER_SCOPE": ['email','user_location', 'friends_location', 'read_friendlists'],
        # "LOG_LEVEL": "DEBUG",
